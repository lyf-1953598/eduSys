...
DATABASES = {
    'default': {
        ...
        'NAME': 'eduSys',  # 数据库名字
        'USER': 'eduSys',  # 用户名
        "PASSWORD": 'root123456*.',  # 自己的密码
        "HOST": '111.229.158.178',
        'PORT': 5432,
    },
}
...
ALLOWED_HOSTS = ['47.239.210.25','0.0.0.0','localhost','metaweb.citory.tech','metopia.cn','127.0.0.1','111.229.158.178']
# 跨域增加忽略
